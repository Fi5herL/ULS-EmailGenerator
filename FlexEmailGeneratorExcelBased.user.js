// ==UserScript==
// @name         Flex Email Generator (Excel)
// @namespace    https://github.com/Fi5herL/ULS-Tampermonkey
// @version      1.0.0
// @description  Flex Email Generator variant — Customize templates are loaded from a local .xlsx file (e.g. OneDrive-synced) via the File System Access API
...
`;
    ...
    // ============================================================
    //  GM_registerMenuCommand 選單
    // ============================================================
    GM_registerMenuCommand('⬇️ Download example .xlsx', () => {
        try {
            ExcelTemplateBuilder.download();
    ...
    GM_registerMenuCommand('📂 Pick Excel file', () => {
        UI._onPickExcel();
    });

    GM_registerMenuCommand('🔄 Reload from Excel', () => {
        UI._onReloadExcel();
    });

    GM_registerMenuCommand('🗑 Forget Excel binding', () => {
        UI._onForgetExcel();
    });

    GM_registerMenuCommand('👁 Toggle panel', () => {
